...
<head>
  ...
  <!--script type="text/javascript" src="js/currency-autocomplete.js"></script-->
    ...
    <div class="CajaUno animated bounceInDown">
            ...
            <input type="text" name="patente" title="formato de patente: AAA 666" id="autocomplete" required pattern="[a-z]{3}[0-9]{3}" />
            <br>
            <input type="file" class="MiBotonUTN" name="foto"  id="foto"/>
            <br>
